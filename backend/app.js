...
const { singleProductView } = require("./controllers/product");

// routes middleware
app.get("/api/product/:productId", singleProductView);
...
if (isProduction) {
  ...
  // redirect the home page route to the react dev server during productio
